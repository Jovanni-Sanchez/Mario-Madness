...
class Tank extends BaseStage {
	...
	override function create() {
		...
		if (!ClientPrefs.data.lowQuality)
			foregroundSprites.add(new BGSprite('tank1', -300, 750, 2, 0.2, ['fg tankhead 5 instance 1']));
		foregroundSprites.add(new BGSprite('tank2', 450, 940, 1.5, 1.5, ['foreground man 3 instance 1']));
		if (!ClientPrefs.data.lowQuality)
			foregroundSprites.add(new BGSprite('tank4', 1300, 900, 1.5, 1.5, ['fg tankman bobbin 3 instance 1']));
		foregroundSprites.add(new BGSprite('tank5', 1620, 700, 1.5, 1.5, ['fg tankhead far right instance 1']));
		if (!ClientPrefs.data.lowQuality)
			foregroundSprites.add(new BGSprite('tank3', 1300, 1200, 3.5, 2.5, ['fg tankhead 4 instance 1']));
